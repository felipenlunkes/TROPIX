...
|*
|*	Versão para alocação estática das tabelas!
|*
...
|*
	...
	movl	_strstart,r5
	movl	r5,r2
	subl	#MAX_DIST,r2		|* limit = strstart-MAX_DIST */
	jhs	limit_ok
	clrl	r2			|* limit = NIL */
limit_ok:
	addl	#_window+2,r5		|* r5 = offset(window+strstart+2) */
...
short_loop:
	andl	#WSIZE-1,r4
	movw	_prev(r4,r4),r4			|* cur_match = prev[cur_match] */
					|* top word of r4 is still 0 */
	cmpl	r2,r4		|* cur_match <= limit ? */
	jls	the_end
	decl	fp			|* --chain_length */
	jz	the_end

do_scan:
	cmpw	_window-1(r3,r4),r0	|* check match at best_len-1 */
	jne	short_loop
	cmpw	_window(r4),r1		|* check min_match_length match */
	jne	short_loop

	leal	_window+2(r4),r4
