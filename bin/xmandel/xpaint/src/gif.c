...
#if (0)	/*******************************************************/
entry int get_lzw_count;
entry int get_code_count;
#endif	/*******************************************************/
...
int		do_extension (FILE *, int, IMAGE *);
...
fprintf (stderr, "width = %d, height = %d\n", header.g_width, header.g_height);
 ...
 */
int
do_extension (FILE *fp, int label, IMAGE *ip)
{
	char		*str, buf[CMAPSZ];
...
#if (0)	/*******************************************************/
printf ("get_code: code_size = %d, count = %d\n", code_size, count);
#endif	/*******************************************************/
...
printf ("EOF, offset = %P\n", ftell (fp));
			...
			if (ZeroDataBlock)
{
printf ("Bloco de tamanho NULO, offset = %d\n", ftell (fp));
				return (-2);
}
#if (0)	/*******************************************************/
...
#endif	/*******************************************************/
#if (0)	/*******************************************************/
printf ("Aumentei o tamanho para %d bits\n",  code_size);
get_lzw_count = 0;
#endif	/*******************************************************/
			}
		}
...
#ifdef	INDEX_DEBUG
	printf ("Acabou a imagem, offset = %P, index_count = %d\n", ftell (fp), index_count);
#endif	INDEX_DEBUG
