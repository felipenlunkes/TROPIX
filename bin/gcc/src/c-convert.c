 ...
 *								*
 *	This file contains the functions for converting C	*
 *	expressions to different data types.  The only entry	*
 *	point is `convert'. Every language front end must	*
 *	have a `convert' function but what kind of conversions	*
 *	it does will depend on the language.			*
 *								*
