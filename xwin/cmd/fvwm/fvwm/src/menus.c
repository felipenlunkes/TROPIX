...
extern FVWMWIN *ButtonWindow, *Tmp_win;
extern XEvent Event;
...
WaitForButtonsUp (void)
{
	...
	if ((mask & (Button1Mask|Button2Mask|Button3Mask|Button4Mask|Button5Mask)) != 0)
		msg ("WaitForButtonsUp: nr. tentativas esgotado, mask = %x", mask);
 ...
 *      t       - the window (FVWMWIN) to test against
 *
 ***********************************************************************/
int ButtonPosition(int context, FVWMWIN * t)
{
  int i;
  int buttons = -1;
