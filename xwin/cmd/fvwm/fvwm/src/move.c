 ...
 *
 ****************************************************************************/
void moveLoop(FVWMWIN *tmp_win, int XOffset, int YOffset, int Width,
...
void DisplayPosition (FVWMWIN *tmp_win, int x, int y,int Init)
{
  char str [100];
  int offset;
...
void InteractiveMove(Window *win, FVWMWIN *tmp_win, int *FinalX, int *FinalY, XEvent *eventp)
{
  ...
  XMoveWindow (dpy, Scr.SizeWindow, Scr.Vx, Scr.Vy);
