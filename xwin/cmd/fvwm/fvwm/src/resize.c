 ...
 *
 ************************************************************************/
void DoResize(int x_root, int y_root, FVWMWIN *tmp_win)
{
  int action=0;
 ...
 *
 ***********************************************************************/
void DisplaySize(FVWMWIN *tmp_win, int width, int height,Bool Init)
{
  char str[100];
...
void ConstrainSize (FVWMWIN *tmp_win, int *widthp, int *heightp)
{
