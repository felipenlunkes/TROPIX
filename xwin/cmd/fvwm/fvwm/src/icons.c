...
void GrabIconButtons(FVWMWIN *, Window);
void GrabIconKeys(FVWMWIN *, Window);
 ...
 *
 ****************************************************************************/
void CreateIconWindow(FVWMWIN *tmp_win, int def_x, int def_y)
{
  int final_x, final_y;
 ...
 *
 ****************************************************************************/
void DrawIconWindow(FVWMWIN *Tmp_win)
{
  GC Shadow, Relief;
 ...
 *
 ************************************************************************/
void RedoIconName(FVWMWIN *Tmp_win)
{
  ...
  else if(t->IconBox[0] >= 0)
    {
	  ...
	  while(((test_y + temp_h) < (t->IconBox[3]+base_y))&&(!loc_ok))
		    ...
		    (!loc_ok))
		{
		  ...
		  while((test_window != (FVWMWIN *)0)&&(loc_ok == True))
		    {
 ...
 *
 ***********************************************************************/
void GrabIconButtons(FVWMWIN *tmp_win, Window w)
{
  Binding *MouseEntry;
 ...
 *
 ***********************************************************************/
void GrabIconKeys(FVWMWIN *tmp_win,Window w)
{
  Binding *tmp;
 ...
 *
 ****************************************************************************/
void GetBitmapFile(FVWMWIN *tmp_win)
{
  char *path = NULL;
  int HotX,HotY;
 ...
 *
 ****************************************************************************/
void GetXPMFile(FVWMWIN *tmp_win)
{
 ...
 *
 ****************************************************************************/
void GetIconWindow(FVWMWIN *tmp_win)
{
 ...
 *
 ****************************************************************************/
void GetIconBitmap(FVWMWIN *tmp_win)
{
  /* We are guaranteed that wmhints is non-null when calling this
   * routine */
 ...
 *
 ***********************************************************************/
void DeIconify(FVWMWIN *tmp_win)
{
  FVWMWIN *t,*tmp;
  ...
  for (t = Scr.FvwmRoot.next; t != NULL; t = t->next)
	  ...
	  ((t->flags & TRANSIENT) &&(t->transientfor == tmp_win->w)))
	{
	  ...
	  Broadcast(M_DEICONIFY,3,t->w,t->frame,(ulong)t);
	}
    }
 ...
 *
 ****************************************************************************/
void Iconify(FVWMWIN *tmp_win, int def_x, int def_y)
{
  FVWMWIN *t;
 ...
 *
 ****************************************************************************/
void SetMapStateProp(FVWMWIN *tmp_win, int state)
{
  ulong data[2];		/* "suggested" by ICCCM version 1 */
  
  data[0] = (ulong) state;
  data[1] = (ulong) tmp_win->icon_w;
/*  data[2] = (ulong) tmp_win->icon_pixmap_w;*/
