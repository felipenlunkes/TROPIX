 ...
 *			probe.h					*
 *								*
 *	Diversas definições universais				*
 *								*
...
#define	EnableIOPorts(a, b)
#define	DisableIOPorts(a, b)
...
typedef int	(*MemCheckFunc) (int);
typedef void	(*SetBank) (int, int, int);
typedef void	(*GetBank) (int, int *, int *);
 ...
 */
/* os.c */
int	enable_user_io (void);
void	disable_user_io (void);
Byte	*MapVGA (void);
void	UnMapVGA (Byte *);
int	ReadBIOS (const unsigned, void *, const int);
...
void	outpl (Word, Long);
Byte	rdinx (Word, Byte);
void	wrinx (Word, Byte, Byte);
void	wrinx2 (Word, Byte, Word);
void	wrinx3 (Word, Byte, Long);
void	wrinx2m (Word, Byte, Word);
void	wrinx3m (Word, Byte, Long);
void	modinx (Word, Byte, Byte, Byte);
void	modreg (Word, Byte, Byte);
void	setinx (Word, Byte, Byte);
void	clrinx (Word, Byte, Byte);
...
Byte	trigdac (void);
Byte	dactocomm (void);
Byte	getdaccomm (void);
void	waitforretrace (void);
Bool	Excluded (Range *, Chip_Descriptor *, Bool);
int	StrCaseCmp (char *, char *);
Int	StrToUL (const char *);

/*
 * Ident functions
 */
int	Probe_Mem (MemCheck_Descriptor);
...
Bool	Probe_Cirrus54 (int *);
Bool	Probe_Cirrus64 (int *);
