/* $XFree86: xc/programs/Xserver/hw/xfree86/drivers/xgi/vb_init.c,v 1.1 2005/05/02 13:28:02 dawes Exp $ */
...
#if 0
static USHORT XGINew_DRAMType[17][5]={{0x0C,0x0A,0x02,0x40,0x39},{0x0D,0x0A,0x01,0x40,0x48},
...
static USHORT XGINew_SDRDRAM_TYPE[13][5]=
{
{ 2,12, 9,64,0x35},
{ 1,13, 9,64,0x44},
{ 2,12, 8,32,0x31},
...
static USHORT XGINew_DDRDRAM_TYPE[4][5]=
{
{ 2,12, 9,64,0x35},
{ 2,12, 8,32,0x31},
{ 2,11, 8,16,0x21},
...
static USHORT XGINew_DDRDRAM_TYPE340[4][5]=
{
{ 2,13, 9,64,0x45},
{ 2,12, 9,32,0x35},
{ 2,12, 8,16,0x31},
...
static USHORT XGINew_DDRDRAM_TYPE20[12][5]=
{
{ 2,14,11,128,0x5D},
{ 2,14,10,64,0x59},
{ 2,13,11,64,0x4D},
...
static void     DualChipInit(PXGI_HW_DEVICE_INFO, PVB_DEVICE_INFO pVBInfo);
...
static void     SetPowerConsume (PXGI_HW_DEVICE_INFO HwDeviceExtension,USHORT XGI_P3d4Port);
...
#ifdef LINUX_KERNEL
void XGIDelayUS(ULONG MicroSeconds)
{
	udelay(MicroSeconds);
}
#endif
...
BOOLEAN XGIInitNew( PXGI_HW_DEVICE_INFO HwDeviceExtension )
{
 ...
 /*   USHORT Mclockdata[ 30 ] , Eclockdata[ 30 ] ; */
   ...
   /* return( FALSE ) ; */
    ...
    XGI_GetVBType( pVBInfo ) ;         /* Run XGI_GetVBType before XGI_InitTo330Pointer */

    XGI_InitTo330Pointer( HwDeviceExtension->jChipType,  pVBInfo ) ;

    /* ReadVBIOSData */
    XGI_ReadVBIOSTablData( HwDeviceExtension->jChipType , pVBInfo) ;
...
*/
    ...
    XGI_Newdebugcode( 0x88 ) ;

    /* Johnson@062403. To save time for power management. */
    /* DelayMS(1000); */
    /* ~Johnson@062403. */
    /* XGINew_SetReg1( pVBInfo->P3d4 , 0x32 , 0x28 ) ; //0207 temp */
    /* XGINew_SetReg1( pVBInfo->P3d4 , 0x36 , 0x02 ) ; //0207 temp */
...
/* --------------------------------------------------------------------- */
static void DualChipInit( PXGI_HW_DEVICE_INFO HwDeviceExtension ,PVB_DEVICE_INFO pVBInfo)
{
    ...
    /* primary chip */
    XGINew_SetReg1( pVBInfo->P3d4 , 0xA0 , 0x72 ) ;
    XGINew_SetReg1( pVBInfo->P3d4 , 0xA1 , 0x81 ) ;
    XGINew_SetReg1( pVBInfo->P3d4 , 0xA2 , 0x60 ) ;
    XGINew_SetReg1( pVBInfo->P3d4 , 0xA3 , 0x20 ) ;
    XGINew_SetReg1( pVBInfo->P3d4 , 0xA4 , 0x50 ) ;
    XGINew_SetReg1( pVBInfo->P3d4 , 0xA5 , 0x40 ) ;
    XGINew_SetReg1( pVBInfo->P3d4 , 0xA8 , 0x88 ) ;
    XGINew_SetReg1( pVBInfo->P3d4 , 0xA9 , 0x10 ) ;
    XGINew_SetReg1( pVBInfo->P3d4 , 0xAA , 0x80 ) ;
    XGINew_SetReg1( pVBInfo->P3d4 , 0xAB , 0x01 ) ;
    XGINew_SetReg1( pVBInfo->P3d4 , 0xAC , 0xF1 ) ;
    XGINew_SetReg1( pVBInfo->P3d4 , 0xAE , 0x80 ) ;
    XGINew_SetReg1( pVBInfo->P3d4 , 0xAF , 0x45 ) ;
    XGINew_SetReg1( pVBInfo->P3d4 , 0xB7 , 0x24 ) ;

    /* secondary chip */
    XGINew_SetReg1( XGINew_2ndP3D4 , 0xA0 , 0x72 ) ;
    XGINew_SetReg1( XGINew_2ndP3D4 , 0xA1 , 0x81 ) ;
    XGINew_SetReg1( XGINew_2ndP3D4 , 0xA2 , 0x60 ) ;
    XGINew_SetReg1( XGINew_2ndP3D4 , 0xA3 , 0x20 ) ;
    XGINew_SetReg1( XGINew_2ndP3D4 , 0xA4 , 0x50 ) ;
    XGINew_SetReg1( XGINew_2ndP3D4 , 0xA5 , 0x40 ) ;
    XGINew_SetReg1( XGINew_2ndP3D4 , 0xA8 , 0x88 ) ;
    XGINew_SetReg1( XGINew_2ndP3D4 , 0xA9 , 0x10 ) ;
    XGINew_SetReg1( XGINew_2ndP3D4 , 0xAA , 0x80 ) ;
    XGINew_SetReg1( XGINew_2ndP3D4 , 0xAB , 0x01 ) ;
    XGINew_SetReg1( XGINew_2ndP3D4 , 0xAC , 0xF1 ) ;
    XGINew_SetReg1( XGINew_2ndP3D4 , 0xAE , 0x80 ) ;
    XGINew_SetReg1( XGINew_2ndP3D4 , 0xAF , 0x45 ) ;
    XGINew_SetReg1( XGINew_2ndP3D4 , 0xB7 , 0x24 ) ;

    /* 06/20/2003 [christine] CRT threshold setting request */
    XGINew_SetReg1( pVBInfo->P3d4 , 0x78 , 0x40 ) ;
    XGINew_SetReg1( pVBInfo->P3d4 , 0x79 , 0x0C ) ;
    XGINew_SetReg1( pVBInfo->P3d4 , 0x7A , 0x34 ) ;
...
/* Description : */
/* --------------------------------------------------------------------- */
static UCHAR XGINew_Get310DRAMType(PVB_DEVICE_INFO pVBInfo)
{
    UCHAR data ;
...
/* Description : */
/* --------------------------------------------------------------------- */
static void XGINew_DDR1x_MRS_340( USHORT P3c4 , PVB_DEVICE_INFO pVBInfo)
{
    ...
    {
        XGIDelayUS( 3000 ) ;	/* Delay 67 x 3 Delay15us */
...
/* Description : */
/* --------------------------------------------------------------------- */
static void XGINew_DDR2x_MRS_340( USHORT P3c4 , PVB_DEVICE_INFO pVBInfo)
{
    XGINew_SetReg1( P3c4 , 0x18 , 0x00 ) ;
    XGINew_SetReg1( P3c4 , 0x19 , 0x20 ) ;
    XGINew_SetReg1( P3c4 , 0x16 , 0x00 ) ;
...
/* Description : */
/* --------------------------------------------------------------------- */
static void XGINew_DDR2_MRS_340( PXGI_HW_DEVICE_INFO HwDeviceExtension ,  USHORT P3c4 , PVB_DEVICE_INFO pVBInfo)
{
    USHORT P3d4 = P3c4 + 0x10 ;
    UCHAR data ;

    XGINew_SetReg1( P3c4 , 0x28 , 0x64 ) ;	/* SR28 */
    XGINew_SetReg1( P3c4 , 0x29 , 0x63 ) ;	/* SR29 */
    XGIDelayUS( 200 ) ;
    XGINew_SetReg1( P3c4 , 0x18 , 0x00 ) ;
    XGINew_SetReg1( P3c4 , 0x19 , 0x20 ) ;
    XGINew_SetReg1( P3c4 , 0x16 , 0x00 ) ;
    XGINew_SetReg1( P3c4 , 0x16 , 0x80 ) ;
    XGINew_SetReg1( P3c4 , 0x18 , 0xC5 ) ;
    XGINew_SetReg1( P3c4 , 0x19 , 0x23 ) ;
    XGINew_SetReg1( P3c4 , 0x16 , 0x00 ) ;
    XGINew_SetReg1( P3c4 , 0x16 , 0x80 ) ;
    XGIDelayUS( 2 ) ;
    ...
    if( P3c4 != pVBInfo->P3c4 )
    {
        ...
        XGINew_SetReg1( P3c4 , 0x28 , data ) ;	/* SR28 */
        data = XGINew_GetReg1( pVBInfo->P3c4 , 0x29 ) ;
        XGINew_SetReg1( P3c4 , 0x29 , data ) ;	/* SR29 */
        data = XGINew_GetReg1( pVBInfo->P3c4 , 0x2A ) ;
        XGINew_SetReg1( P3c4 , 0x2A , data ) ;	/* SR2A */

        data = XGINew_GetReg1( pVBInfo->P3c4 , 0x2E ) ;
        XGINew_SetReg1( P3c4 , 0x2e , data ) ;	/* SR2E */
        data = XGINew_GetReg1( pVBInfo->P3c4 , 0x2F ) ;
        XGINew_SetReg1( P3c4 , 0x2f , data ) ;	/* SR2F */
        data = XGINew_GetReg1( pVBInfo->P3c4 , 0x30 ) ;
        XGINew_SetReg1( P3c4 , 0x30 , data ) ;	/* SR30 */
    }
    else
        XGINew_SetMemoryClock( HwDeviceExtension , pVBInfo ) ;
    ...
    XGIDelayUS( 5 ) ;
    /* XGINew_SetReg1( P3c4 , 0x18 , 0x72 ) ; */
    XGINew_SetReg1( P3c4 , 0x18 , pVBInfo->SR15[ 2 ][ XGINew_RAMType ] ) ;	/* SR18 */
    XGINew_SetReg1( P3c4 , 0x19 , 0x06 ) ;
    XGINew_SetReg1( P3c4 , 0x16 , 0x05 ) ;
    XGINew_SetReg1( P3c4 , 0x16 , 0x85 ) ;
    XGIDelayUS( 1 ) ;
}
...
/* Description : */
/* --------------------------------------------------------------------- */
static void XGINew_DDR1x_DefaultRegister( PXGI_HW_DEVICE_INFO HwDeviceExtension ,  USHORT Port , PVB_DEVICE_INFO pVBInfo)
{
    USHORT P3d4 = Port ,
           P3c4 = Port - 0x10 ;
...
/* Description : */
/* --------------------------------------------------------------------- */
static void XGINew_DDR2x_DefaultRegister( PXGI_HW_DEVICE_INFO HwDeviceExtension ,  USHORT Port ,PVB_DEVICE_INFO pVBInfo)
{
    USHORT P3d4 = Port ,
           P3c4 = Port - 0x10 ;
...
/* Description : */
/* --------------------------------------------------------------------- */
static void XGINew_DDR2_DefaultRegister( PXGI_HW_DEVICE_INFO HwDeviceExtension, USHORT Port , PVB_DEVICE_INFO pVBInfo)
{
    USHORT P3d4 = Port ,
           P3c4 = Port - 0x10 ;
...
/* Description : */
/* --------------------------------------------------------------------- */
static void XGINew_VerifyMclk( PXGI_HW_DEVICE_INFO  HwDeviceExtension , PVB_DEVICE_INFO pVBInfo)
{
...
/* Description : */
/* --------------------------------------------------------------------- */
static void XGINew_DisableChannelInterleaving( int index , USHORT XGINew_DDRDRAM_TYPE[][ 5 ] , PVB_DEVICE_INFO pVBInfo)
{
    USHORT data ;
...
/* Description : */
/* --------------------------------------------------------------------- */
static void XGINew_SetDRAMSizingType( int index , USHORT DRAMTYPE_TABLE[][ 5 ] ,PVB_DEVICE_INFO pVBInfo)
{
    USHORT data ;
...
/* Description : */
/* --------------------------------------------------------------------- */
static int XGINew_SetRank( int index , UCHAR RankNo , UCHAR XGINew_ChannelAB , USHORT DRAMTYPE_TABLE[][ 5 ] , PVB_DEVICE_INFO pVBInfo)
{
    USHORT data ;
    int RankSize ;
...
/* Description : */
/* --------------------------------------------------------------------- */
static int XGINew_SetDDRChannel( int index , UCHAR ChannelNo , UCHAR XGINew_ChannelAB , USHORT DRAMTYPE_TABLE[][ 5 ] , PVB_DEVICE_INFO pVBInfo)
{
    USHORT  data ;
    int RankSize ;
...
/* Description : */
/* --------------------------------------------------------------------- */
static int XGINew_CheckColumn( int index , USHORT DRAMTYPE_TABLE[][ 5 ], PVB_DEVICE_INFO pVBInfo)
{
    int i ;
...
/* Description : */
/* --------------------------------------------------------------------- */
static int XGINew_CheckBanks( int index , USHORT DRAMTYPE_TABLE[][ 5 ], PVB_DEVICE_INFO pVBInfo)
{
    int i ;
    ULONG Increment , Position ;
...
/* Description : */
/* --------------------------------------------------------------------- */
static int XGINew_CheckRank( int RankNo , int index , USHORT DRAMTYPE_TABLE[][ 5 ], PVB_DEVICE_INFO pVBInfo)
{
    int i ;
    ULONG Increment , Position ;
...
/* Description : */
/* --------------------------------------------------------------------- */
static int XGINew_CheckDDRRank( int RankNo , int index , USHORT DRAMTYPE_TABLE[][ 5 ], PVB_DEVICE_INFO pVBInfo)
{
    ULONG Increment , Position ;
    USHORT data ;
...
/* Description : */
/* --------------------------------------------------------------------- */
static int XGINew_CheckRanks( int RankNo , int index , USHORT DRAMTYPE_TABLE[][ 5 ], PVB_DEVICE_INFO pVBInfo)
{
    int r ;
...
/* Description : */
/* --------------------------------------------------------------------- */
static int XGINew_CheckDDRRanks( int RankNo , int index , USHORT DRAMTYPE_TABLE[][ 5 ], PVB_DEVICE_INFO pVBInfo)
{
    int r ;
...
/* Description : */
/* --------------------------------------------------------------------- */
static USHORT XGINew_SetDRAMSizeReg( int index , USHORT DRAMTYPE_TABLE[][ 5 ], PVB_DEVICE_INFO pVBInfo)
{
...
/* Description : */
/* --------------------------------------------------------------------- */
static USHORT XGINew_SetDRAMSize20Reg( int index , USHORT DRAMTYPE_TABLE[][ 5 ], PVB_DEVICE_INFO pVBInfo)
{
    USHORT data = 0 , memsize = 0 ;
    int RankSize ;
    UCHAR ChannelNo ;
...
/* Description : */
/* --------------------------------------------------------------------- */
static int XGINew_ReadWriteRest( USHORT StopAddr , USHORT StartAddr, PVB_DEVICE_INFO pVBInfo)
{
    int i ;
    ULONG Position = 0 ;
    ...
    *( ( PULONG )( pVBInfo->FBAddr + Position ) ) = Position ;
    ...
    XGIDelayUS( 500 ) ;	/* [Vicent] 2004/04/16. Fix #1759 Memory Size error in Multi-Adapter. */
...
/* Description : */
/* --------------------------------------------------------------------- */
static void XGINew_CheckChannel( PXGI_HW_DEVICE_INFO HwDeviceExtension, PVB_DEVICE_INFO pVBInfo)
{
    UCHAR data;
		...
		XGIDelayUS( 15 ) ;
          ...
          {	
              if (( HwDeviceExtension->ulVideoMemorySize - 1 ) > 0x800000)
              {
                ...
                XGINew_DataBusWidth = 16 ;	/* 16 bits */
                XGINew_SetReg1( pVBInfo->P3c4 , 0x13 , 0xB1 ) ;
                XGINew_SetReg1( pVBInfo->P3c4 , 0x14 , 0x41 ) ;
                XGIDelayUS( 15 ) ;
...
/* Description : */
/* --------------------------------------------------------------------- */
static BOOLEAN ChkLFB( PVB_DEVICE_INFO pVBInfo )
{
...
/* --------------------------------------------------------------------- */
/* Function : XGI_ReadVBIOSTablData */
/* Input : */
/* Output : */
/* Description : */
/* --------------------------------------------------------------------- */
void XGI_ReadVBIOSTablData( UCHAR ChipType , PVB_DEVICE_INFO pVBInfo)
{
    PUCHAR  volatile pVideoMemory = ( PUCHAR )pVBInfo->ROMAddr ;
    ULONG   i ;
    UCHAR   j , k ;
