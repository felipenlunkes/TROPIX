/*
 * $XFree86: xc/programs/Xserver/hw/xfree86/drivers/tseng/tseng_driver.c,v 1.104 2007/01/23 18:03:10 tsi Exp $ 
 *
...
static Bool TsengScreenInit(int Index, ScreenPtr pScreen, const int argc,
    const char **argv);
...
static Bool
TsengScreenInit(int scrnIndex, ScreenPtr pScreen,
