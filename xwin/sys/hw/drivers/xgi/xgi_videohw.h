/* $XFree86: xc/programs/Xserver/hw/xfree86/drivers/xgi/xgi_videohw.h,v 1.1 2005/05/02 13:28:02 dawes Exp $ */
...
void XGI_SetOverlayReg(XGIPtr, XGIOverlayPtr);
void XGI_SetColorkeyReg(XGIPtr, CARD32);
void XGI_SetSelectOverlayReg(XGIPtr, CARD8);
void XGI_SetCloseOverlayReg(XGIPtr pXGI);
void XGI_SetEnableOverlayReg(XGIPtr, Bool);

void XGIResetVideo(ScrnInfoPtr);

void XGI_SetVideoContrastReg(XGIPtr, INT32);
void XGI_SetVideoBrightnessReg(XGIPtr, INT32);
void XGI_SetVideoSaturationReg(XGIPtr, INT32);
void XGI_SetVideoHueReg(XGIPtr, INT32);

void XGI_EnableCaptureAutoFlip(XGIPtr, Bool);
