/*
 * $XFree86: xc/programs/Xserver/fb/fbpict.c,v 1.18 2006/12/27 03:04:33 tsi Exp $
 *
...
#define fbComposeConvertFormat(source, picture) { \
    if (PICT_FORMAT_TYPE((picture)->pFormat->format) == PICT_TYPE_ABGR) { \
	CARD32 tmp = source; \
\
	src = (tmp & 0xff00ff00) | \
	      ((tmp & 0x00ff0000) >> 16) | \
			       ...
			       CARD16     height)
{
    ...
    fbComposeConvertFormat(src, pDst);
